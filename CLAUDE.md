...
- `lihi-shorturl/includes/config.php` — returns a flat array of plugin configuration values (`api_domain`, `redirect_domain`, `api_key`, `auth_domain`). Loaded lazily by `lihi_config()` and cached for the request lifetime.
